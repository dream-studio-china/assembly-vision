...
1. [Cover and status](design/00-cover-and-status.md)
...
The documents are a draft architecture baseline for engineering and customer validation. They do not claim that the system has been implemented, deployed, or accepted.
