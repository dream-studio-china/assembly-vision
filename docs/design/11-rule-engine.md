...
- pipeline: `CAMERA_DISCONNECTED`, `NO_PRODUCT`, `MULTIPLE_PRODUCTS`, `ROI_INVALID`, `INSUFFICIENT_VALID_FRAMES`, `INFERENCE_ERROR`, `IMAGE_READ_ERROR`, `PRODUCT_IDENTITY_MISSING`, `PRODUCT_IDENTITY_TRANSITION`, `COMPONENT_POLICY_MISSING`, `GATE_FAILED:<gate>`;
