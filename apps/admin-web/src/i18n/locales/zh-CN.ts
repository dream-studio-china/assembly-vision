...
export default {
  ...
  "Product versions": "产品版本",
  "Rule versions": "规则版本",
  "Model versions": "模型版本",
  Components: "组件",
  "Expected count": "期望数量",
  "Required components": "必需组件",
  "Barcode mappings": "条码映射",
  Version: "版本",
  Versions: "版本",
  Status: "状态",
  Published: "已发布",
  ...
  "Publish reason": "发布原因",
  "Content hash": "内容哈希",
  "Mandatory gates": "强制门控",
  "Barcode required": "需要条码",
  "Minimum usable frames": "最少可用帧数",
  "Uncertain maps to NG": "不确定映射为 NG",
  "Component policies": "组件策略",
  "High confidence": "高置信度",
  "Medium confidence": "中置信度",
  "Minimum medium detections": "最少中置信检测数",
  "Adjacent frames required": "需要相邻帧",
  "Compatible component models": "兼容组件模型",
  Task: "任务",
  Runtime: "运行时",
  "Input size": "输入尺寸",
  Classes: "类别",
  ...
  "No barcode mappings.": "无条码映射。",
  "No component policies.": "无组件策略。",
  "No artifacts declared.": "未声明工件。",
  "No desired configurations yet.": "暂无期望配置。",
  "Failed to load products.": "加载产品失败。",
  "Failed to load rules.": "加载规则失败。",
  "Failed to load models.": "加载模型失败。",
  "Failed to load desired configurations.": "加载期望配置失败。",
  "Failed to load the product.": "加载产品失败。",
  "Failed to load the rule.": "加载规则失败。",
  "Failed to load the model.": "加载模型失败。",
  "Back to products": "返回产品",
  "Back to rules": "返回规则",
  "Back to models": "返回模型",
"Desired configuration only. Packages are installed manually in M1. Assignment is not proof of download, validation, or activation.": "仅为期望配置。M1 中软件包由人工安装。分配不代表已下载、已校验或已激活。",
  "Governed versions": "受治理版本",
  "No components defined.": "未定义组件。",
  ...
  "Product model version": "产品模型版本",
  "Component model version": "组件模型版本",
  "Rule version": "规则版本",
  "Product {code}": "产品 {code}",
  "Rule {code}": "规则 {code}",
  "Model {code}": "模型 {code}",
  "Version {n}": "版本 {n}",
  ...
  "No rules yet.": "暂无规则。",
  "No models yet.": "暂无模型。",
  "No compatible component models.": "无兼容组件模型。",
  "No mandatory gates.": "无强制门控。",
  "Current desired bundles per device. Assignment is desired state only.":
    "每台设备的当前期望配置。分配仅为期望状态。",
};
