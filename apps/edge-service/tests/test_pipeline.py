...
def _product_detection(frame_id: UUID) -> ProductDetection:
    return ProductDetection(
        ...
        confidence=0.95,
        bbox=BoundingBox(
            x_min=100.0, y_min=80.0, x_max=700.0, y_max=520.0, image_width=800, image_height=600
        ),
...
def _component_obs(frame_id: UUID, code: str) -> ComponentDetection:
    return ComponentDetection(
        ...
        roi_bbox=BoundingBox(
            x_min=10.0, y_min=10.0, x_max=100.0, y_max=100.0, image_width=680, image_height=512
        ),
        full_frame_bbox=BoundingBox(
            x_min=70.0, y_min=54.0, x_max=160.0, y_max=144.0, image_width=800, image_height=600
        ),
