...
Mirrors the edge-service problem contract so central and edge clients see the
same RFC 7807 shape; never exposes credentials, object keys, SQL, or stack
traces in the payload.
"""
